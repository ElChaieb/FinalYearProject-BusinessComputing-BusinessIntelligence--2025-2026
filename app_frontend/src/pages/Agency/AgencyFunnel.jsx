...
// ─── Per-commercial breakdown (replace with datawarehouse hook) ─────────────────
const COMMERCIALS = [
  {
    name: "Ahmed",
    oppoWon: 634,
  ...
  { name: "Ali", oppoWon: 130, oppoLost: 30, quoteWon: 128, quoteLost: 2 },
];

// ─── Per-commercial breakdown — previous year (replace with datawarehouse hook) ─
const COMMERCIALS_PREV = [
  { name: "Ahmed",   oppoWon: 570, oppoLost: 172, quoteWon: 480, quoteLost: 85 },
  { name: "Mohamed", oppoWon: 430, oppoLost: 148, quoteWon: 362, quoteLost: 68 },
  { name: "Salem",   oppoWon: 318, oppoLost: 112, quoteWon: 265, quoteLost: 53 },
  { name: "Fatma",   oppoWon: 205, oppoLost: 68,  quoteWon: 170, quoteLost: 35 },
  { name: "Ali",     oppoWon: 98,  oppoLost: 22,  quoteWon: 96,  quoteLost: 2  },
];
...
// ─── Donut card — single donut, one year, slices per commercial ───────────────
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: 12 }}>
        <h1 style={{ margin: 0, fontSize: 20, fontWeight: 600, color: PBI.textPrimary }}>
          Conversion Rates
        </h1>
        <p style={{ margin: "2px 0 0", fontSize: 12, color: PBI.textMuted }}>
          Opportunities → Quotes → Sales · {CURRENT_MONTH_LABEL} vs {PREVIOUS_MONTH_LABEL}
        </p>
      </div>
      ...
      {/* ── Funnel (tall left) + 3×2 KPI grid (right) ── */}
      <div
        style={{
          display: "grid",
          ...
          <div style={{ display: "flex", justifyContent: "space-around", marginTop: 8 }}>
            {[
              ...
              <div key={label} style={{ textAlign: "center" }}>
                <p style={{ margin: 0, fontSize: 20, fontWeight: 700, color }}>{rate}%</p>
                <p style={{ margin: "2px 0 0", fontSize: 10, color: PBI.textMuted }}>{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {[
        {
          rowLabel: "Opportunities", yearLabel: "Year n-1",
          commercials: COMMERCIALS_PREV.map((c) => ({ ...c, oppoTotal: c.oppoWon + c.oppoLost, quoteTotal: c.quoteWon + c.quoteLost })),
          cards: [
        ...
        {
          rowLabel: "Opportunities", yearLabel: "Year n",
          commercials: COMMERCIALS.map((c) => ({ ...c, oppoTotal: c.oppoWon + c.oppoLost, quoteTotal: c.quoteWon + c.quoteLost })),
          cards: [
            { title: "Total Opportunities", valueKey: "oppoTotal" },
            { title: "Won Opportunities",   valueKey: "oppoWon"   },
            { title: "Lost Opportunities",  valueKey: "oppoLost"  },
        ...
        {
          rowLabel: "Quotes", yearLabel: "Year n-1",
          commercials: COMMERCIALS_PREV.map((c) => ({ ...c, oppoTotal: c.oppoWon + c.oppoLost, quoteTotal: c.quoteWon + c.quoteLost })),
          cards: [
        ...
        {
          rowLabel: "Quotes", yearLabel: "Year n",
          commercials: COMMERCIALS.map((c) => ({ ...c, oppoTotal: c.oppoWon + c.oppoLost, quoteTotal: c.quoteWon + c.quoteLost })),
          cards: [
            { title: "Total Quotes", valueKey: "quoteTotal" },
            { title: "Won Quotes",   valueKey: "quoteWon"   },
      ...
      ].map(({ rowLabel, yearLabel, commercials, cards }, idx) => (
        <div key={idx} style={{ marginTop: 16 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>
            {cards.map((c) => (
              <DonutCard key={c.title} title={c.title} valueKey={c.valueKey} commercials={commercials} />
            ))}
          </div>
        </div>
      ))}
