...
// Hook to access commercial-scope filters (year)
...
function YearPicker({ value, onChange }) {
  // Small year selection control used in commercial filter bars
...
export function FilterBar({ style }) {
  const { selectedYear, setSelectedYear, clearFilters, isFiltered } =
    useFilter();
  return (
    <div
      style={{
