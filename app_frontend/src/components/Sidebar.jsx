...
// Sidebar.jsx renders the application navigation menu and role-based page links
...
const DASHBOARD_NAV = [
  {
    label: "Revenue",
    path: "/directors/revenue",
    icon: RevenueIcon,
    roles: DIRECTOR_ROLES,
  },
  {
    label: "Funnel",
    path: "/directors/funnel",
    icon: FunnelIcon,
    roles: DIRECTOR_ROLES,
  },
  {
    label: "Trends",
    path: "/directors/trends",
    icon: TrendsIcon,
    roles: DIRECTOR_ROLES,
  },
  {
...
// Main application sidebar: renders nav links adapted to user role
export default function Sidebar() {
  const { user, logout } = useAuth();
  const { isOpen, toggle } = useSidebar();
  const role = user?.role;

  const dashboardLinks = DASHBOARD_NAV.filter((item) =>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: "#a19f9d", marginTop: 1 }}>
              {role}
            </div>
          </div>
        </div>
      ...
      <nav
        style={{
          flex: 1,
          padding: isOpen ? "12px 8px" : "12px 4px",
          overflowY: "auto",
          overflowX: "hidden",
        }}
      >
        ...
        {topLinks.length > 0 && (
          <>
            <div
              style={{ height: 1, background: "#edebe9", margin: "8px 0 12px" }}
            />
      ...
      <div
        style={{
          padding: isOpen ? "12px 8px 16px" : "12px 4px 16px",
      ...
      >
        ...
        {isOpen ? (
          <button
            ...
            onMouseEnter={(e) => {
              e.target.style.borderColor = "#d13438";
              e.target.style.color = "#d13438";
              e.target.style.background = "#fde7e9";
            }}
            onMouseLeave={(e) => {
              e.target.style.borderColor = "#edebe9";
              e.target.style.color = "#605e5c";
...
function RevenueIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
      <path
        d="M1 12 L4 8 L7 9.5 L11 5 L15 3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function TrendsIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
      <path
        d="M1 14 L5 9 L8 11 L12 6 L15 4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function ChatIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none">
      <path
        d="M2 2h12a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H5l-3 3V3a1 1 0 0 1 1-1z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
