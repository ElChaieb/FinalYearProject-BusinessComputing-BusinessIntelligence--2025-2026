/**
 * FilterContext.v1-no-agency.jsx
 *
 ...
 *   const { selectedCommercial } = useFilter();
...
// Flat list of all commercials across all agencies
...
export function FilterProvider({ children, commercials = COMMERCIAL_DATA }) {
...
export function FilterBar({ style }) {
  const {
    ...
    setCommercial, clearFilters, isFiltered,
  } = useFilter();
